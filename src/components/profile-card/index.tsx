...
export function ProfileCard(): JSX.Element {
  ...
  return (
    <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
      ...
      <div
        id="profile"
        className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0 dark:bg-gray-900"
      >
        <div className="p-4 md:p-12 text-center lg:text-left dark:bg-gray-800">
          {/* Image for mobile view */}
          <div
            className={`"block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" + ${styles.mbProfile}`}
          ></div>
